...
export const BADGES = [
  ...
  { id: 'teardown', emoji: '🪛', name: 'Tiny Tech Detective', desc: 'Found 10 parts inside a laptop or phone' },
  { id: 'curious', emoji: '🔍', name: 'Curious Mind', desc: 'Learned about 10 different parts' },
];
export const AVATARS = ['🦊', '🐼', '🦁', '🐸', '🐙', '🦄', '🐯', '🐧', '🤖', '🚀'];

// ---------- Teardown: laptop and phone vs the desktop ----------
export const TEARDOWN = {
  laptop: {
    name: 'Laptop', emoji: '💻', tagline: 'A whole PC folded into 1.5 cm',
    stats: [['Thickness', '~1.5 cm'], ['Weight', '~1.4 kg'], ['Battery', '~70 Wh'], ['Power use', '~15–45 W']],
    kid: 'A laptop has the same kinds of parts as the big computer you built: a brain, a desk, a backpack and an artist. But everything is squished flat so it folds up and fits in a bag. It even carries its own electricity in a battery!',
    adult: 'A laptop trades upgradability and raw power for size and battery life. Most parts are soldered to one small custom logic board, the processor runs at 15–45 W instead of 100+ W, and cooling is a single thin blower fan (or none at all). The battery takes up about half the inside.',
    parts: {
      display: { name: 'Screen (in the lid)', emoji: '🖥️', kid: 'The screen is built into the lid. Thin wires go through the hinge to carry the picture.', adult: 'A 14-inch IPS or OLED panel in the lid, connected to the board by an eDP cable through the hinge. The Wi-Fi antennas usually sit in the lid too, because metal in the base would block the signal.', desktop: 'A separate monitor, plugged into the graphics card.' },
      webcam: { name: 'Webcam', emoji: '📷', kid: 'A tiny camera above the screen for video calls with Grandma.', adult: 'A small camera module (often 1080p) with microphones beside it, and a privacy LED that lights up whenever the camera is on.', desktop: 'Usually a separate USB webcam.' },
      keyboard: { name: 'Keyboard & top case', emoji: '⌨️', kid: 'The keyboard is built in, so you can type with the laptop on your lap.', adult: 'A low-profile scissor-switch keyboard (about 1 mm of key travel) fixed to the metal top case, often with a backlight underneath.', desktop: 'A separate keyboard on a cable.' },
      trackpad: { name: 'Trackpad', emoji: '👆', kid: 'Slide your finger on it to move the pointer, just like a mouse!', adult: 'A glass capacitive touch surface. Many modern trackpads don’t physically click: a haptic motor fakes the click feeling.', desktop: 'A mouse.' },
      battery: { name: 'Battery', emoji: '🔋', kid: 'A laptop carries its own energy in flat battery packs, like a lunchbox full of electricity!', adult: 'Lithium-ion polymer cells in series, about 50–100 Wh (airlines allow up to 100 Wh in hand luggage). It charges over USB-C Power Delivery, and a battery-management chip protects the cells.', desktop: 'No battery: the power supply turns wall electricity into 12 V.' },
      board: { name: 'Logic board', emoji: '🏙️', kid: 'The motherboard is much smaller, and oddly shaped to fit around the battery and fan.', adult: 'A compact, many-layer logic board with almost everything soldered on, cut to a custom shape around the battery and cooling.', desktop: 'A big standard ATX motherboard with slots for upgrades.' },
      soc: { name: 'Processor', emoji: '🧠', kid: 'The brain and the artist live on the same chip here, to save space and battery.', adult: 'Laptop processors combine CPU cores, an integrated GPU, media engines and usually an AI accelerator (NPU), running at about 15–45 W. Gaming laptops add a separate mobile graphics chip.', desktop: 'A separate CPU in a socket plus a big graphics card.' },
      ram: { name: 'Memory (soldered)', emoji: '📝', kid: 'The desk is glued right next to the brain. You can’t add more later, so pick enough when you buy!', adult: 'Usually LPDDR5/5X chips soldered next to the processor: faster and lower power, but not upgradable. Some laptops still use SO-DIMM or the newer CAMM2 modules.', desktop: 'RAM sticks you can swap or add.' },
      ssd: { name: 'SSD', emoji: '🎒', kid: 'A tiny backpack for all your files and games.', adult: 'A short M.2 2230 or 2280 NVMe SSD. Some very thin laptops solder the storage chips to the board instead.', desktop: 'An M.2 SSD, with room for more drives.' },
      wifi: { name: 'Wi-Fi & Bluetooth', emoji: '📶', kid: 'Talks to the internet using invisible radio waves, with no cable needed.', adult: 'A small Wi-Fi 6E/7 + Bluetooth module. Thin antenna cables run through the hinge up into the lid.', desktop: 'Wi-Fi on the motherboard, or a network cable.' },
      cooling: { name: 'Cooling', emoji: '❄️', kid: 'One flat fan and a flat copper pipe carry the heat out of the back. Some laptops have no fan at all!', adult: 'A centrifugal blower fan pushes air through a thin fin stack, fed by a flattened heat pipe or vapour chamber over the processor. Fanless designs spread the heat into the case and slow down when they get hot.', desktop: 'Big 120 mm fans and a tall tower cooler.' },
      speakers: { name: 'Speakers', emoji: '🔊', kid: 'Two tiny speakers, one on each side.', adult: 'Small drivers in sealed boxes. Laptops use digital signal processing to make them sound bigger than they are.', desktop: 'Separate speakers or headphones.' },
      ports: { name: 'USB-C ports', emoji: '🔌', kid: 'One kind of plug does everything: charging, screens and gadgets.', adult: 'USB-C / Thunderbolt carries power (USB Power Delivery), data and DisplayPort video over one reversible connector.', desktop: 'Lots of different ports on the back.' },
      bottom: { name: 'Bottom cover', emoji: '🔩', kid: 'Unscrew the bottom to see inside, but some laptops need tiny special screwdrivers!', adult: 'An aluminium bottom case held by small Torx or pentalobe screws, often with clips as well. Many laptops still let you replace the SSD, battery or fan.', desktop: 'Side panels that come off with thumb screws, no tools needed.' },
    },
  },
  phone: {
    name: 'Phone', emoji: '📱', tagline: 'A computer that fits in your pocket',
    stats: [['Thickness', '~0.8 cm'], ['Weight', '~190 g'], ['Battery', '~17 Wh'], ['Power use', '~2–8 W']],
    kid: 'A phone is a tiny computer! It still has a brain, a desk, a backpack and a heart (the battery). They’re just shrunk down and squeezed together like puzzle pieces, and it adds cameras and a radio to talk to cell towers.',
    adult: 'A smartphone packs a full computer into about 100 cm³: a system-on-chip with the RAM stacked on top, NAND storage, a cellular modem, several cameras, sensors and a battery that fills most of the inside. The logic board is often a two-layer “sandwich” to leave room for the battery.',
    parts: {
      display: { name: 'Touchscreen', emoji: '📱', kid: 'The screen is also the touch pad! It feels exactly where your finger is.', adult: 'An OLED panel: every pixel makes its own light (around 460 pixels per inch). It has a capacitive touch layer and tough cover glass, and refreshes up to 120 Hz.', desktop: 'A separate monitor, keyboard and mouse.' },
      frame: { name: 'Metal frame', emoji: '🔲', kid: 'The strong metal edge that holds everything together, with the buttons on it.', adult: 'An aluminium or titanium frame. The thin plastic lines in it split the metal into antennas for 5G, Wi-Fi and GPS.', desktop: 'The case.' },
      board: { name: 'Logic board', emoji: '🏙️', kid: 'The motherboard is folded in half like a sandwich to fit in the tiny space!', adult: 'A stacked two-layer “sandwich” logic board joined by an interposer. It uses half the area, leaving more room for the battery.', desktop: 'A 30 cm motherboard.' },
      soc: { name: 'System on a chip', emoji: '🧠', kid: 'The brain, the artist and the AI helper, all in one chip smaller than your fingernail.', adult: 'A phone SoC: CPU cores, GPU, NPU, image signal processor and media engines, built on about 3 nm. It sips a few watts, bursts fast, then slows down to stay cool.', desktop: 'A separate CPU and graphics card that use hundreds of watts.' },
      ram: { name: 'Memory (stacked)', emoji: '📝', kid: 'The desk sits right on top of the brain, like a hat!', adult: 'LPDDR memory (often 8–12 GB) stacked directly on the SoC (package-on-package) for the shortest wires and lowest power.', desktop: 'RAM sticks in slots.' },
      storage: { name: 'Storage chip', emoji: '🎒', kid: 'The backpack chip that holds your photos and apps.', adult: 'One NAND flash package, from 128 GB to 1 TB, on a fast NVMe or UFS interface.', desktop: 'An M.2 SSD.' },
      modem: { name: 'Modem & radios', emoji: '📡', kid: 'Talks to cell towers, so you can call and use the internet almost anywhere.', adult: 'The cellular modem and RF front end (5G / LTE), plus Wi-Fi, Bluetooth, GPS and NFC radios, all feeding antennas built into the frame.', desktop: 'A Wi-Fi card or a network cable, and no cell towers!' },
      battery: { name: 'Battery', emoji: '🔋', kid: 'The biggest part inside! It fills most of the phone.', adult: 'One lithium-ion pouch cell, about 4,000–5,000 mAh at ~3.9 V (roughly 15–19 Wh). That’s about a quarter of a laptop battery.', desktop: 'The power supply, plugged into the wall.' },
      cameras: { name: 'Cameras', emoji: '📸', kid: 'Three cameras with different lenses: normal, super-wide and zoom.', adult: 'A wide main camera with a large sensor, plus ultra-wide and telephoto cameras, each with its own lens stack. Stabilisation shifts the sensor or lens thousands of times per second to cancel out shaky hands.', desktop: 'Usually no camera, or a USB webcam.' },
      taptic: { name: 'Vibration motor', emoji: '📳', kid: 'Makes the buzz you feel when the phone vibrates.', adult: 'A linear resonant actuator: a small mass on springs, moved by a magnetic coil, for crisp and precise taps.', desktop: 'Nothing like it!' },
      speaker: { name: 'Speaker & port', emoji: '🔊', kid: 'A tiny loudspeaker at the bottom, next to the charging plug.', adult: 'The bottom loudspeaker (the earpiece at the top doubles as a second speaker for stereo) and the USB-C port for charging and data.', desktop: 'Separate speakers, and lots of ports.' },
      coil: { name: 'Wireless charging coil', emoji: '🌀', kid: 'A spiral of copper wire lets the phone charge just by lying on a charger, with no plug!', adult: 'Qi wireless charging: a coil in the charger makes a changing magnetic field, which induces a current in this coil. A ring of magnets can snap the charger into the right spot.', desktop: 'Plugged into the wall.' },
      back: { name: 'Glass back', emoji: '🪟', kid: 'The glass back. Glass lets the wireless charging and radio signals through.', adult: 'The back glass lets radio signals and the wireless-charging field pass through, where a solid metal back would block them. The camera bump holds the lenses.', desktop: 'A steel case with a glass side window.' },
    },
  },
};
